          ...
          >
            <div className="mb-6">
              ...
              <p className="text-white/63 font-poppins text-[16px] leading-[30px]">
                SentrySol is an AI-native, on-device behavioral security framework built 
                specifically for Web3 mobile environments, initially focusing on Solana Mobile Seeker.
              </p>
            </div>
          </motion.div>
        </div>
