...
export default function WalletScreening() {
  ...
  const [investigationType, setInvestigationType] = useState<
    "full" | "sanctions" | "tracing" | "media" | "visualization"
  >("full");
  ...
  const handleScreening = async () => {
    ...
    try {
      if (investigationType === "full") {
        ...
        const result = await mcpApiClient.investigateAddressWithAgents(
          address,
          "full",
        );
  ...
  const getSeverityIcon = (severity: string) => {
    switch (severity) {
      case "critical":
        return <AlertTriangle className="h-4 w-4 text-risk-red" />;
      case "high":
        return <AlertTriangle className="h-4 w-4 text-warning-amber" />;
      case "medium":
        return <Info className="h-4 w-4 text-brand-light" />;
      case "low":
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
          <div>
            ...
            <p className="text-muted-foreground">
              AI-powered wallet risk assessment and compliance screening
            </p>
          </div>
          {!isReady && (
            <Badge
          ...
          <div className="space-y-4">
            <Card className="h-fit">
              <CardHeader>
                ...
                <CardDescription>
                  Connect your wallet to auto-populate the address and start
                  analysis
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter a Solana or Ethereum address for comprehensive
            ...
            <div className="space-y-4">
              <div className="flex space-x-4">
                <div className="flex-1">
                  ...
                  />
                  {address && !isValidAddress && (
                    <p className="text-sm text-risk-red mt-1">
                      Please enter a valid Solana or Ethereum address
                    </p>
                  )}
                </div>
                {walletConnected && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                <Button
                  ...
                  disabled={
                    !isValidAddress || investigation.isLoading || !isReady
                  }
                ...
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge
                    className={getRiskBadgeColor(
                      investigation.result.riskScore,
                    )}
                  >
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span
                        className={getRiskColor(investigation.result.riskScore)}
                      >
                        {investigation.result.riskScore >= 70
                          ? "High Risk"
                          : investigation.result.riskScore >= 40
                            ? "Medium Risk"
                            : "Low Risk"}
                      </span>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-3 bg-card border rounded-lg">
                      <div className="text-lg font-bold text-warning-amber">
                        {
                          investigation.result.findings.filter(
                            (f) =>
                              f.severity === "high" ||
                              f.severity === "critical",
                          ).length
              ...
              <TabsContent value="findings" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Detailed analysis results from multiple intelligence
                      sources
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {investigation.result.findings.length > 0 ? (
                      <div className="space-y-4">
                        {investigation.result.findings.map(
                          (finding: any, index: number) => (
                            ...
                            >
                              ...
                              <div className="text-sm text-muted-foreground">
                                ...
                                Severity: {finding.severity} • Time:{" "}
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground">
                          This address passed all screening checks
                        </p>
                      </div>
                    )}
                  </CardContent>
              ...
              <TabsContent value="compliance">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Regulatory and sanctions screening results
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 border rounded-lg">
                          ...
                          <div className="flex items-center space-x-2 mb-1">
                            {investigation.result.compliance.sanctionsStatus
                              .isMatch ? (
                              <XCircle className="h-4 w-4 text-risk-red" />
                            ) : (
                              <CheckCircle className="h-4 w-4 text-success-green" />
                        ...
                        <div className="p-4 border rounded-lg">
                          ...
                          <div className="flex items-center space-x-2 mb-1">
                            {investigation.result.compliance.pepStatus
                              .isMatch ? (
                      ...
                      <div className="p-4 border rounded-lg">
                        ...
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <span>
                            {
                              investigation.result.compliance.adverseMedia
                                .articles.length
                            }{" "}
                            articles found
                          </span>
                    ...
                    {tracingData ? (
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          {tracingData.flowPatterns &&
                          tracingData.flowPatterns.length > 0 ? (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              {tracingData.flowPatterns.map(
                        ...
                        <div>
                          ...
                          {tracingData.riskIndicators &&
                          tracingData.riskIndicators.length > 0 ? (
                            <div className="space-y-2">
                              {tracingData.riskIndicators.map(
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div className="p-3 bg-muted rounded-lg text-center">
                                <div className="text-lg font-bold text-brand-light">
                                  {tracingData.temporalAnalysis.velocityMetrics?.avgTxPerDay?.toFixed(
                                    1,
                                  ) || "N/A"}
                                </div>
                                <div className="text-sm text-muted-foreground">
                              ...
                              <div className="p-3 bg-muted rounded-lg text-center">
                                <div className="text-lg font-bold text-warning-amber">
                                  {tracingData.temporalAnalysis.velocityMetrics
                                    ?.maxTxPerDay || "N/A"}
                                </div>
                                <div className="text-sm text-muted-foreground">
                                  Max Tx/Day
                              ...
                              <div className="p-3 bg-muted rounded-lg text-center">
                                <div className="text-lg font-bold text-success-green">
                                  {tracingData.temporalAnalysis.velocityMetrics?.velocityScore?.toFixed(
                                    0,
                                  ) || "N/A"}
                                </div>
                                <div className="text-sm text-muted-foreground">
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground mb-4">
                          Run blockchain tracing to see detailed transaction
                          analysis
                        </p>
                        <Button
                          onClick={handleBlockchainTracing}
                ...
                {visualizationData ? (
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Interactive network graph of transaction flows
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground mb-4">
                          Generate flow visualization to see interactive network
                          graph
                        </p>
                        <Button
                          onClick={handleGenerateVisualization}
              ...
              <TabsContent value="network">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Transaction patterns and network connections
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="text-center py-8">
              ...
              <TabsContent value="metadata">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Additional information about this address
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-sm">
                          {investigation.result.address}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Label:</span>
                        <span>
                          {investigation.result.metadata.label || "Unknown"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Category:</span>
                        <span>
                          {investigation.result.metadata.category || "Unknown"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Verified:</span>
                        <span>
                          {investigation.result.metadata.verified
                            ? "Yes"
                            : "No"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <span>
                          {new Date(
                            investigation.result.metadata.lastUpdated,
                          ).toLocaleString()}
                        </span>
                      </div>
                    </div>
