  ...
  return (
    <div className="min-h-screen overflow-hidden relative">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, #000 0%, #395B64 50%, #395B64 75%, #000 100%)",
        }}
      />

      {/* Line Pattern Background */}
      <div className="fixed inset-0 z-1 opacity-20"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <motion.div variants={itemVariants} className="mb-16">
                <h2 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-light text-white mb-8 font-poppins">
                  Vision
                </h2>
              ...
              <motion.div variants={itemVariants}>
                ...
                <p className="text-white text-lg sm:text-xl font-light leading-relaxed font-poppins">
                  ...
                  <br />
                  <br />
                  Securing the Ecosystem, Protecting against evolving threats
                  like blind signing and wallet draining.
                  <br />
                  <br />
                  Driving Adoption, Making Web3 accessible and safe for
                  everyone.
                </p>
              </motion.div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div variants={itemVariants} className="order-1 lg:order-2">
              <h2
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #A5C9CA 0%, #E7F6F2 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  fontFamily: "Poppins",
                  letterSpacing: "2px",
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 z-10 relative">
        ...
        >
          ...
          >
            We're building the future of Web3 mobile security,
            <br />a future{" "}
            <span className="font-medium">where you're always protected.</span>
          </motion.p>
      ...
      <footer className="bg-[#2C3333] py-20 px-4 sm:px-6 lg:px-8 z-10 relative">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <motion.div
              variants={itemVariants}
              className="bg-[#E9E9E9] rounded-2xl p-6"
            >
              <h3 className="text-black text-lg font-semibold mb-6 font-poppins">
                Explore
              </h3>
              <div className="space-y-4">
                {["Press & Media", "Community", "Contact"].map((item) => (
                  <a
                    key={item}
                    href="#"
                    className="block text-[#9A9A9A] text-sm hover:text-black transition-colors font-poppins"
                  >
                    {item}
                  </a>
                ))}
            ...
            >
              ...
              <div className="space-y-4">
                {["Whitepaper", "Documentation", "Integration", "Blog"].map(
                  (item) => (
                    <a
                      key={item}
                      href="#"
